...
import os
import pymysql
from dotenv import load_dotenv # module to import .env
load_dotenv() # function which import .env from the same dir
# Database connection parameters - update as needed
DB_USER=os.getenv('DB_USER') or 'admin'
DB_PSWD=os.getenv('DB_PSWD_RDS') or None
DB_NAME=os.getenv('DB_NAME2') or 'task_logger'
DB_HOST=os.getenv('DB_HOST_RDS') or 'db-1.cyqyr2weamyp.us-west-2.rds.amazonaws.com'
